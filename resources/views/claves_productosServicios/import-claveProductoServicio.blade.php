...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Importar datos de claves de productos y servicios</div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('claves_productosServicios.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
